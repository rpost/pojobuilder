...
you might want to download the [`pojobuilder-4.3.1-jar-with-dependencies.jar`] to get PojoBuilder complete with all dependent libraries included.
...
dependencies {
  compile 'io.github.rpost:pojobuilder:4.3.1'
}
```
...
dependencies {
  codeGeneration 'io.github.rpost:pojobuilder:4.3.1'
  compileOnly 'io.github.rpost:pojobuilder:4.3.1:annotations'
}
...
```groovy
dependencies {
  annotationProcessor 'io.github.rpost:pojobuilder:4.3.1'
}
```
